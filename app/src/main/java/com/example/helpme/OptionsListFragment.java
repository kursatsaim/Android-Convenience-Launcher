...
public class OptionsListFragment extends Fragment {
    ...
    private Button buttonUp, buttonDown, buttonRight,mainUp,mainDown,mainRight;
    int Prof1Vis, Prof2Vis, Prof3Vis;
    MainActivity mainActivity = new MainActivity(mainUp,mainDown,mainRight);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mainActivity.SetProfile1Visibility();
            }
        });
        ...
        buttonRight.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mainActivity.SetProfile2Visibility();
            }
        });
        ...
        buttonDown.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mainActivity.SetProfile3Visibility();
            }
        });

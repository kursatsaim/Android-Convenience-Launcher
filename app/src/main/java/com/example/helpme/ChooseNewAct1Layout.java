...
public class ChooseNewAct1Layout extends AppCompatActivity {
    ...
    public static final String SHARED_PREF_ACT1 = "NewAct1AppsListPrefs";
    public static final String KEY_STRING_REAL_NEWACT1_APP_LIST = "KeyRealNewAct1AppList";
    SharedPreferences prefs;
    String json;
    New_Added_Act1 newAddedAct1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_choose_new_act1_layout);

        newAct1List = new NewAct1List(this);
        newAddedAct1 = new New_Added_Act1();
        ...
        RecyclerView recyclerView = findViewById(R.id.act1chooserecview);
        ...
        AdapterChooseAppsForNewAct1 adapt = new AdapterChooseAppsForNewAct1(this,mainliste,newAct1List);
        recyclerView.setAdapter(adapt);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        LoadSharedPrefs();

        newAct1List.GetChosenApps(chosenapps);
        newAddedAct1.getact1apps(chosenapps);
    ...
    public void LoadSharedPrefs()
    {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREF_ACT1,Context.MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString(KEY_STRING_REAL_NEWACT1_APP_LIST,"");
